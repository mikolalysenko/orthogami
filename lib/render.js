...
function renderTab(
  ...
  if(open) {
    generateTab(0.1, 0.225, 0.2)
    generateTab(0.2, 0.225, 0.05)
    generateSeam(0.1)
  } else {
...
function renderUnfoldingToSVG(
  ...
  console.log('tabs=', util.inspect(tabs, {depth: 10}))
  console.log('creases=', util.inspect(creases, {depth: 10}))
  ...
  var strokeColor = options.tabColor || "black"
